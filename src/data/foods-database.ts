...
export const EXPANDED_FOODS: FoodItem[] = [
  ...
  {
    id: 'fd74',
    name: 'Açaí 200ml (Sem Complementos)',
    category: 'Fast-Food',
    servingSizeG: 200,
    servingUnit: 'ml',
    calories: 150,
